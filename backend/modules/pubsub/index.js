// dependencies
var debug = require('debug')('hoardr-scraper:pubsub');
...
exports = module.exports = function (rpc, ipc) {
    ...
    rpc.subscriber.on('message', function (channel, message){
        ...
        data ? ipc.emit('add', data) : debug('data not defined - erronous input: ' + util.inspect(message));
    });
